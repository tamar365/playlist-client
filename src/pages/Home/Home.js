...
function App() {
  ...
  try {
    useEffect(() => {
      fetch("https://myplaylistmusic.herokuapp.com/api/playlists", {
        method: "GET",
        headers: {
  ...
  const getSongs = (userInput) => {
    fetch(`https://myplaylistmusic.herokuapp.com/api/search/${userInput}`)
  ...
  const newSongFunc = (poem) => {
    ...
    fetch("https://myplaylistmusic.herokuapp.com/api/songs/newsong", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        authorization: `bearer ${localStorage.getItem("accessToken")}`,
      ...
      .then((data) =>
        fetch(
          "https://myplaylistmusic.herokuapp.com/api/playlists/addToPlaylist",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const removeSongFunc = (id) => {
    fetch(`https://myplaylistmusic.herokuapp.com/api/playlists/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        authorization: `bearer ${localStorage.getItem("accessToken")}`,
